" NOT MY WORK. This file contains my edits to ~\nvim\colors\onedark.vim
...
call s:h("Function", { "fg": s:blue, "gui": "italic" }) " function name (also: methods for classes)
call s:h("Statement", { "fg": s:purple, "gui": "bold", "cterm": "bold" }) " any statement
call s:h("Conditional", { "fg": s:purple, "gui": "bold", "cterm": "bold" }) " if, then, else, endif, switch, etc.
call s:h("Repeat", { "fg": s:purple, "gui": "bold", "cterm": "bold" }) " for, do, while, etc.
call s:h("Label", { "fg": s:purple, "gui": "bold", "cterm": "bold" }) " case, default, etc.
